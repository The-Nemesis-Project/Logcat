...
import com.infamous.logcat.widget.MockDisabledListPreference;
import com.infamous.logcat.widget.MultipleChoicePreference;
...
public class SettingsActivity extends PreferenceActivity implements OnPreferenceChangeListener {
	...
	private void openDonateVersionInMarket() {
		...
		Intent intent = new Intent(Intent.ACTION_VIEW, 
				Uri.parse("market://details?id=com.infamous.site2"));
		startActivity(intent);
	}
